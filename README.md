...
- The diagram is intentionally simplified for clarity; the real repo also includes deployment manifests, Terraform, and helper scripts (see `deployment/`, `aws-fargate-terraform/`, and `docker-compose/`).
